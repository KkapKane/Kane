import "../../styles/homepage/title.scss";
import arrow from "../../assets/arrow.png";
import { useState, useEffect } from "react";

export default function Title() {
  const [introText, setIntroText] = useState("Hi I'm Kane");
  const letters: string = "ABCDEFGHIJKLMNOPQRSTUVWZYZ";

  let originalText = "HI I'M KANE";
      ...
      <div className='intro'>
        ...
        <div id='description-container'>
          <div id='arrowDes-container'>
            <div id='description'>
              I'VE BEEN PROGRAMMING FOR 4 YEARS <br />
              WITH 1 YEAR IN WEB DEV. LETS CONNECT!
            </div>
